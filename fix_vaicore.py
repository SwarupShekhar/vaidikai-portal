...
def main():
    ...
    required_projects = [
        {
            ...
            "default_id": "1",
            "config": """<View>
  <Audio name="audio" value="$audio" zoom="true" hotkey="space"/>
  ...
  <TextArea name="transcript" toName="audio" perRegion="true" placeholder="Edit transcript..." rows="2" editable="true"/>

  <Header value="Conversation"/>
  <Paragraphs name="dialogue" value="$dialogue" layout="dialogue" nameKey="author" textKey="text"/>
  <ParagraphLabels name="labels" toName="dialogue">
    <Label value="Agent" background="#2196F3"/>
    <Label value="Customer" background="#4CAF50"/>
    <Label value="Teacher" background="#FF9800"/>
    <Label value="Student" background="#9C27B0"/>
